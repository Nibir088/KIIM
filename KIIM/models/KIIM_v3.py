...
from models.multiStreamBackbonewSwin import *
...
class KIIM(pl.LightningModule):
    ...
    def forward(
        ...
        if self.use_attention:
            ...
            output_dict['AM_conv1'] = output['AM-conv1']
            output_dict['AM_conv2'] = output['AM-conv2']
            output_dict['AM-sig'] = output['AM-sig']
        ...
        if self.use_projection:
            ...
            output_dict['CPM_logits'] = logits['CPM_feature']
            output_dict['CPM_feature'] = logits['CPM_feature']
            output_dict['logits'] = logits['weighted_ensemble']
            logits = logits['weighted_ensemble']
        # Apply final softmax
