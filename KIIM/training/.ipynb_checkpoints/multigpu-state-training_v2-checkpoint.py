...
from models.KIIM_v2 import KIIM
...
class OptunaObjective:
    ...
    def __call__(self, trial: Trial) -> float:
        ...
        try:
            ...
            best_score = trainer.callback_metrics.get(f"{trial_cfg.train.monitor}", torch.tensor(0.0))
...
@hydra.main(config_path="/project/biocomplexity/wyr6fx(Nibir)/IJCAI-25_Irrigation_Mapping/Pytorch-Lightening/KIIM/config", config_name="multigpu-state-training-KIIM", version_base="1.2")
